...
// //         // dispatch(fetchPendingApprovals('MANAGER'));
// //       } else {
// //         throw new Error(result?.message || 'Failed to approve task completion');
// //       }
// //     } catch (error) {
...
// //           </div>
// //           <button
// //             onClick={() => dispatch(fetchPendingApprovals('MANAGER'))}
// //             disabled={loading}
...
// //                         }`}>
// //                           {approvedRequests.has(request.id) ? 'APPROVED' : request.status}
// //                         </span>
// //                       </div>
...
// //                         disabled={processingId === request.id || approvedRequests.has(request.id)}
...
// //                           <Check className="w-4 h-4" />
// //                         )}
// //                         {approvedRequests.has(request.id) ? '' : 'Approve Completion'}
// //                       </button>
...
// //                       >
// //                         <X className="w-4 h-4" />
// //                         {approvedRequests.has(request.id) ? 'Rejected' : 'Reject'}
// //                       </button>
// //                     </div>
// //                   </div>
// //                 </div>
