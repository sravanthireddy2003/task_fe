...
const Analysis = () => {
 ...
 useEffect(() => {
    ...
    const pieData = tasks.map(task => ({
        name: task.title,
        value: task.assigned_users?.length || 0,
    }));
...
//   const projectData = [
//     { name: 'Project Ac', completed: 85, inProgress: 15, onHold: 0 },
//     { name: 'Project B', completed: 65, inProgress: 25, onHold: 10 },
//     { name: 'Project C', completed: 45, inProgress: 40, onHold: 15 },
//     { name: 'Project D', completed: 90, inProgress: 10, onHold: 0 },
//     { name: 'Project E', completed: 70, inProgress: 20, onHold: 10 },
//   ];
const projectData = tasks.map((task) => {
    ...
    if (task.stage === "COMPLETED") {
      ...
      // Calculate progress as a percentage of time passed
  ...
  return (
    <div className="p-6 space-y-6 bg-gray-100">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold">Performance Analytics Dashboard</h1>
        <select 
          value={timeFrame} 
      ...
      <div className="mb-4">
        <div className="flex border-b">
          <button
            className={`px-4 py-2 font-medium ${activeTab === 'projects' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
            onClick={() => setActiveTab('projects')}
          >
            Project Analysis
          </button>
          <button
            className={`px-4 py-2 font-medium ${activeTab === 'teams' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600'}`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* <div className="bg-white p-4 rounded-lg shadow">
            <div className="mb-4">
              ...
              <p className="text-gray-600">Status breakdown by project</p>
            </div>
    ...
    <ResponsiveContainer width="100%" height={projectData.length * 50}>
      ...
      <ResponsiveContainer width={500} height={500}>
        <BarChart data={data} layout="vertical" margin={{ top: 20, right: 20, left: 20, bottom: 5 }}>
          ...
          <Tooltip />
          <Legend />
          {/* <Bar dataKey="count" fill="data.color" /> */}
          <Bar dataKey="count">
    {data.map((entry, index) => (
      <Cell key={`cell-${index}`} fill={entry.color} />
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="mb-4">
              ...
              <p className="text-gray-600">Distribution across projects</p>
            </div>
      ...
      {activeTab === 'teams' && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="mb-4">
              <h2 className="text-xl font-bold">Team Performance Metrics</h2>
              <p className="text-gray-600">Key performance indicators by team</p>
            </div>
          ...
          <div className="bg-white p-4 rounded-lg shadow">
            <div className="mb-4">
              <h2 className="text-xl font-bold">Team Performance Trend</h2>
...
//                 </div>
//             ) : (
//                 <p>Team analysis data will be displayed here.</p>
//             )}
//         </div>
//     );
// };
