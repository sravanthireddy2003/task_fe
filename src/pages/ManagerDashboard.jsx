      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-section-title text-gray-900">Task Status Distribution</h3>
                <p className="text-small-text text-gray-600 mt-1">Breakdown of tasks by status</p>
              </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-section-title text-gray-900">Tasks Per Project</h3>
                <p className="text-small-text text-gray-600 mt-1">Task count across projects</p>
              </div>
              <div className="flex items-center gap-2">
                <button className="btn btn-secondary !px-2 !w-8 !h-8 icon-center border-transparent shadow-none hover:bg-gray-100">
                  <MoreVertical className="w-5 h-5 text-gray-500" />
        ...
        <div className="mb-8">
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-section-title text-gray-900">Priority Distribution</h3>
                <p className="text-small-text text-gray-600 mt-1">Task breakdown by priority level</p>
              </div>
            </div>
            <div className="h-48">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
          ...
          <div className="border-b border-gray-200 p-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <h3 className="text-section-title text-gray-900">Task Overview</h3>
                <p className="text-small-text text-gray-600 mt-1">
                  {tasks.length} tasks total â€¢ {metrics.activeTasks || 0} active â€¢ {metrics.overdueTasks || 0} overdue
                </p>
              </div>
              <div className="flex items-center gap-3">
                {/* View Toggle */}
                <div className="flex bg-gray-100 rounded-lg p-1">
                  <button
                    ...
                    className={`btn px-3 ${viewMode === 'list' ? 'btn-primary' : 'btn-secondary bg-white border-gray-300'}`}
                  >
                  ...
                  <button
                    ...
                    className={`btn px-3 ${viewMode === 'grid' ? 'btn-primary' : 'btn-secondary bg-white border-gray-300'}`}
                  >
                ...
                {/* Sort and Filter */}
                <select className="input !w-auto h-10 py-0">
                    ...
                    <tr>
                      <td colSpan="7" className="py-12 text-center">
                        <div className="flex flex-col items-center justify-center">
                          ...
                          <h4 className="text-section-title mb-2">No tasks found</h4>
