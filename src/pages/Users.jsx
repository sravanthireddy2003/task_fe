...
//       <td className='p-2'>{user.email || "user.email@example.com"}</td>
...
//             className='flex flex-row-reverse gap-1 items-center bg-blue-600 text-white rounded-md 
//             onClick={() => setOpen(true)}
//           />
//         </div>

//         <div className='bg-white px-2 md:px-4 py-4 shadow-md '>
