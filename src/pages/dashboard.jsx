    ...
    <div className="max-w-7xl mx-auto px-6 py-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-page-title text-gray-900 tracking-tight leading-tight">Admin Dashboard</h1>
            <p className="text-small-text text-gray-500 mt-1 font-medium">System overview & management</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="pl-11 pr-4 py-2.5 w-full border border-gray-200 rounded-xl text-sm bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-500 shadow-sm transition-all"
              onChange={onSearch}
            />
          </div>

          <select
            className="border border-gray-200 text-sm px-4 py-2.5 rounded-xl bg-white shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600 font-semibold min-w-[90px]"
            value={timeFilter}
      ...
      {[
        ...
        <div key={i} className="group relative overflow-hidden bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-xl hover:border-gray-300 transition-all duration-300 hover:-translate-y-2 h-[200px] flex flex-col">
          ...
          <div className="p-6 pt-8 border-b border-gray-50 relative z-10">
            ...
            <h3 className="text-section-title text-gray-900 text-center leading-tight group-hover:text-gray-800 transition-colors">{label}</h3>
          </div>
...
const UsersTable = ({ users }) => (
  <div className="bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden mb-8">
    <div className="border-b border-gray-200 px-8 py-8 bg-gray-50">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-section-title text-gray-900 tracking-tight">User Management</h2>
          <p className="text-gray-600 mt-2 text-small-text font-medium">Manage system users, roles & permissions</p>
        </div>
        <button className="btn btn-primary shadow-xl hover:shadow-2xl transition-all whitespace-nowrap">
          + Add Admin User
        </button>
      </div>
    </div>
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8 mb-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-section-title text-gray-900 tracking-tight">Task Analytics</h2>
          <p className="text-small-text text-gray-600 mt-1 font-medium">System-wide task performance</p>
        </div>
